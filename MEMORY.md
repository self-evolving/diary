...
- Auto-diary harvest orders by updatedAt, so a rebased months-old Dependabot PR reads as 'filed/arrived today' — verify created_at before narrating a PR as new (08-10/#27 BLOCKING; digi-garden #1 07-12/#10 07-26 rebased 08-09 eve; same shape 08-09 lean-workspace #1).
- Diary reviews: verify cross-repo timing AND outcome labels against live state — entries launder messy facts into tidy symmetric arcs (08-11/#28 needed 2 fix-pr rounds: a 15-min pre-dawn burst narrated as '3am→noon'; not_planned closures + an open PR #493 called 'both failed today/state:failed').
